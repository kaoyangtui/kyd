...
-- pigx jsonflow
create database `pigxx_jsonflow` default character set utf8mb4 collate utf8mb4_general_ci;

-- pigx order
create database `pigxx_order` default character set utf8mb4 collate utf8mb4_general_ci;
