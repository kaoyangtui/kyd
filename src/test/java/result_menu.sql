...
-- 菜单SQL
insert into sys_menu (menu_id, parent_id, path, permission, menu_type, icon, del_flag, create_time, sort_order,
                      update_time, name, tenant_id)
values (1747056861501, '-1', '/admin/result/index', '', '0', 'icon-bangzhushouji', '0', null, '8', null,
        '科研成果表管理', 1);

-- 菜单对应按钮SQL
insert into sys_menu (menu_id, parent_id, permission, menu_type, path, icon, del_flag, create_time, sort_order,
                      update_time, name, tenant_id)
