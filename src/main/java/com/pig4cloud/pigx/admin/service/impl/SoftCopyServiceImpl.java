...
public class SoftCopyServiceImpl extends OrderCommonServiceImpl<SoftCopyMapper, SoftCopyEntity> implements SoftCopyService, FlowStatusUpdater {
    ...
    private void doSaveOrUpdate(SoftCopyCreateRequest request, boolean isCreate) {
        ...
        if (isCreate) {
            ...
            params.put("orderName", entity.getSoftName());
    ...
    public IPage<SoftCopyResponse> pageResult(Page reqPage, SoftCopyPageRequest request) {
        ...
        if (CollUtil.isNotEmpty(request.getIds())) {
            ...
            wrapper.eq(ObjectUtil.isNotNull(request.getDeptId()), SoftCopyEntity::getDeptId, request.getDeptId());
